...
var _user$project$Main$decodeDateTime = function (datetimeString) {
	var _p0 = _elm_lang$core$Date$fromString(datetimeString);
	if (_p0.ctor === 'Err') {
...
var _user$project$Main$hintedAxisAtMin = function (hinted) {
				...
				labels: function () {
					...
					if (_p3.ctor === 'Nothing') {
						return A2(
							...
							{
								ctor: '::',
								_0: _terezka$elm_plot$Plot$simpleLabel(
									A2(_myrho$elm_round$Round$roundNum, 3, summary.dataMax)),
								_1: {ctor: '[]'}
							});
					} else {
						return A2(
...
var _user$project$Main$rangeFrameAxis = F2(
	function (hinted, toValue) {
		return _terezka$elm_plot$Plot$customAxis(
			function (summary) {
				return {
					...
					labels: function () {
						...
						if (_p6.ctor === 'Nothing') {
							...
							return A2(_user$project$Main$hintLabel, hinted, toValue);
						}
					}(),
					flipAnchor: false
				};
...
var _user$project$Main$flashyLine = F3(
	function (x, y, hinted) {
...
var _user$project$Main$blueStroke = '#cfd8ea';
var _user$project$Main$title = function (txt) {
	return A2(
		_terezka$elm_plot$Plot$viewLabel,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$fill(_user$project$Main$blueStroke),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$style('text-anchor: end; font-style: italic; font-size:10px'),
				_1: {ctor: '[]'}
			}
		},
		txt);
};
var _user$project$Main$legend = F3(
	function (xLegend, yLegend, summary) {
		var verticalCenter = summary.y.dataMax / 2;
		return {
			ctor: '::',
			_0: A3(
				_terezka$elm_plot$Plot$junk,
				_user$project$Main$title(yLegend),
				summary.x.dataMin - 30,
				verticalCenter),
			_1: {
				ctor: '::',
				_0: A3(
					_terezka$elm_plot$Plot$junk,
					_user$project$Main$title(xLegend),
					summary.x.max,
					summary.y.dataMin - ((summary.y.dataMin - summary.y.min) / 1.3)),
				_1: {ctor: '[]'}
			}
		};
	});
var _user$project$Main$basicSeries = F3(
	function (hovered, xLegend, yLegend) {
		return _terezka$elm_plot$Plot$viewSeriesCustom(
...
var _user$project$Main$renderPageItem = function (page) {
	return A2(
...
var _user$project$Main$renderPageList = function (runs) {
	return A2(
		_elm_lang$html$Html$ul,
		{ctor: '[]'},
		A2(
			_elm_lang$core$List$map,
			_user$project$Main$renderPageItem,
			_user$project$Main$uniquePages(runs)));
};
var _user$project$Main$renderGraphItem = F2(
	function (current, _p12) {
		var _p13 = _p12;
		var _p14 = _p13._0;
		return A2(
			_elm_lang$html$Html$option,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Attributes$selected(
						_elm_lang$core$Native_Utils.eq(current, _p14)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Main$allColors = {
	ctor: '::',
	_0: '#ff9edf',
	_1: {
		ctor: '::',
...
var _user$project$Main$buildGroups = function (runs) {
	var insertOrUpdate = F2(
		function (run, currentList) {
			var _p15 = currentList;
	...
	return _elm_lang$core$Dict$toList(
		A3(
			...
			A2(
				_elm_lang$core$List$map,
				function (r) {
					return {ctor: '_Tuple2', _0: r.run.groupName, _1: r};
				},
				runs)));
};
var _user$project$Main$defaultFilteredGroups = function (runs) {
	return A2(
		_elm_lang$core$List$map,
		_elm_lang$core$Tuple$first,
		_user$project$Main$buildGroups(runs));
};
var _user$project$Main$assignColors = function (runs) {
	return _elm_lang$core$List$concat(
		A2(
			_elm_lang$core$List$map,
			function (_p18) {
				...
				return A2(
					_elm_lang$core$List$map,
					function (r) {
						return {ctor: '_Tuple2', _0: _p19._0, _1: r};
					},
					_p19._1._1);
			},
			A2(
				_elm_community$list_extra$List_Extra$zip,
				_user$project$Main$allColors,
				_user$project$Main$buildGroups(runs))));
};
var _user$project$Main$Stats = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {meanTime: a, successHits: b, serverErrorHits: c, maxTime: d, minTime: e, userErrorHits: f, totalTime: g, failedHits: h, variance: i, hits: j};
									};
								};
							};
						};
...
var _user$project$Main$decodeStats = A3(
							...
							A3(
								...
								A3(
									...
									A3(
										...
										'meanTime',
										_elm_lang$core$Json_Decode$float,
										_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Stats)))))))))));
var _user$project$Main$RunInfo = F5(
	function (a, b, c, d, e) {
		return {created: a, concurrency: b, groupName: c, id: d, match: e};
	});
var _user$project$Main$decodeRunInfo = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'match',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			A3(
				...
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'created',
					A2(_elm_lang$core$Json_Decode$andThen, _user$project$Main$decodeDateTime, _elm_lang$core$Json_Decode$string),
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$RunInfo))))));
var _user$project$Main$getRuns = function (name) {
	return A2(
		_elm_lang$http$Http$get,
		A2(
			_elm_lang$core$Basics_ops['++'],
			'http://localhost:3000/runs?match=',
			_elm_lang$http$Http$encodeUri(name)),
		A2(
			_elm_lang$core$Json_Decode$field,
			'runs',
			_elm_lang$core$Json_Decode$list(_user$project$Main$decodeRunInfo)));
};
var _user$project$Main$Run = F3(
	function (a, b, c) {
		return {pages: a, stats: b, run: c};
	});
var _user$project$Main$decodeRun = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'run',
	_user$project$Main$decodeRunInfo,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'stats',
		_user$project$Main$decodeStats,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'pages',
			_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string),
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Run))));
var _user$project$Main$getSingleRun = function (id) {
	return A2(
		_elm_lang$http$Http$get,
		A2(
			_elm_lang$core$Basics_ops['++'],
		...
		_user$project$Main$decodeRun);
};
var _user$project$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {runTitles: a, searchField: b, runs: c, graph: d, hovered: e, filteredGroups: f, concurrencyComparison: g};
	});
var _user$project$Main$ChangeConcurrencyComparison = function (a) {
	return {ctor: 'ChangeConcurrencyComparison', _0: a};
};
var _user$project$Main$renderConcurrencySelector = F2(
	function (current, runs) {
		var _p20 = current;
		if (_p20.ctor === 'Nothing') {
			return _elm_lang$html$Html$text('');
		} else {
			var buildOption = function (level) {
				return A2(
					_elm_lang$html$Html$option,
					{
						ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$selected(
								_elm_lang$core$Native_Utils.eq(_p20._0, level)),
							_1: {ctor: '[]'}
						}
					},
					{
			...
			var levels = _elm_lang$core$List$sort(
				_elm_community$list_extra$List_Extra$unique(
					A2(
						_elm_lang$core$List$map,
						function (_p21) {
							return function (_) {
								return _.concurrency;
							}(
								function (_) {
									return _.run;
								}(_p21));
			...
			return A2(
				...
				{
					ctor: '::',
					_0: _user$project$Main$onChangeInt(_user$project$Main$ChangeConcurrencyComparison),
					_1: {ctor: '[]'}
				},
				A2(_elm_lang$core$List$map, buildOption, levels));
		}
	});
var _user$project$Main$ToggleFilterGroup = function (a) {
	return {ctor: 'ToggleFilterGroup', _0: a};
};
var _user$project$Main$renderGroupItem = F2(
	function (filtered, _p22) {
		var _p23 = _p22;
		var _p25 = _p23._1;
			...
			if (_p24.ctor === '[]') {
				...
				return _elm_lang$core$List$isEmpty(
					A2(
						_elm_lang$core$List$filter,
						function (g) {
							return _elm_lang$core$Native_Utils.eq(g, _p25.run.groupName);
						},
						filtered));
			}
		}();
		return A2(
			_elm_lang$html$Html$li,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Attributes$classList(
						{
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'grayed-out', _1: isFiltered},
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Main$ToggleFilterGroup(_p25.run.groupName)),
						_1: {ctor: '[]'}
					}
				}
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$span,
					{
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'color', _1: _p23._0},
								_1: {
									ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(_p25.run.groupName),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Main$renderGroups = F2(
	function (filteredGroups, runs) {
		var groups = A2(
			_elm_community$list_extra$List_Extra$uniqueBy,
			_elm_lang$core$Tuple$first,
			_user$project$Main$assignColors(
				A2(
		...
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Main$renderGroupItem(filteredGroups),
				groups));
	});
var _user$project$Main$ChangeGraphType = function (a) {
	return {ctor: 'ChangeGraphType', _0: a};
};
var _user$project$Main$RunTitleClicked = function (a) {
	return {ctor: 'RunTitleClicked', _0: a};
};
var _user$project$Main$runListItem = function (title) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_user$project$Main$RunTitleClicked(title)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: _elm_lang$svg$Svg_Events$onMouseOut(
										_user$project$Main$Hover(_elm_lang$core$Maybe$Nothing)),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Main$rangeFrameHintDot = F4(
	function (xGetter, yGetter, hinted, _p27) {
		var _p28 = _p27;
		var _p29 = _p28._1;
		var y = yGetter(_p29);
		var x = xGetter(_p29);
		return {
			view: _elm_lang$core$Maybe$Just(
				A3(_user$project$Main$circle, _p28._0, x, y)),
			xLine: A2(
				_elm_lang$core$Maybe$andThen,
				A2(_user$project$Main$flashyLine, x, y),
				hinted),
			yLine: A2(
				_elm_lang$core$Maybe$andThen,
				A2(_user$project$Main$flashyLine, x, y),
...
var _user$project$Main$scatterPlot = F3(
	function (xGetter, yGetter, hinting) {
		return {
			axis: A2(
				_user$project$Main$rangeFrameAxis,
				hinting,
			...
			toDataPoints: _elm_lang$core$List$map(
				A3(_user$project$Main$rangeFrameHintDot, xGetter, yGetter, hinting))
		};
	});
var _user$project$Main$linePlot = F3(
	function (xGetter, yGetter, hinting) {
		return {
			axis: _user$project$Main$hintedAxisAtMin(hinting),
			interpolation: A2(
				_terezka$elm_plot$Plot$Monotone,
				_elm_lang$core$Maybe$Nothing,
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$stroke(_user$project$Main$blueStroke),
					_1: {ctor: '[]'}
				}),
			toDataPoints: _elm_lang$core$List$map(
				A3(_user$project$Main$rangeFrameHintDot, xGetter, yGetter, hinting))
...
var _user$project$Main$LoadRunStats = function (a) {
	return {ctor: 'LoadRunStats', _0: a};
};
var _user$project$Main$LoadRunList = function (a) {
	return {ctor: 'LoadRunList', _0: a};
};
var _user$project$Main$LoadRunTitles = function (a) {
	return {ctor: 'LoadRunTitles', _0: a};
};
var _user$project$Main$init = function () {
	var model = {
		...
		filteredGroups: {ctor: '[]'},
		concurrencyComparison: _elm_lang$core$Maybe$Nothing
	};
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: A2(
			...
			_user$project$Main$LoadRunTitles,
			_user$project$Main$getRuns(''))
	};
}();
var _user$project$Main$SearchButtonClicked = {ctor: 'SearchButtonClicked'};
var _user$project$Main$SearchFieldUpdated = function (a) {
	return {ctor: 'SearchFieldUpdated', _0: a};
};
var _user$project$Main$leftPanel = F2(
	function (defaultTitle, runTitles) {
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Wrecker-UI'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('view-header__search'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$name('run_name'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$placeholder('Search Run'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(defaultTitle),
												_1: {
													ctor: '::',
													_0: _user$project$Main$onEnter(_user$project$Main$SearchButtonClicked),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SearchFieldUpdated),
														_1: {ctor: '[]'}
													}
												}
											}
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$SearchButtonClicked),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('view-header__runs'),
								_1: {ctor: '[]'}
							},
							A2(_elm_lang$core$List$map, _user$project$Main$runListItem, runTitles)),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _user$project$Main$Timeline = F2(
	function (a, b) {
		return {ctor: 'Timeline', _0: a, _1: b};
	});
var _user$project$Main$Scatter = F4(
	function (a, b, c, d) {
		return {ctor: 'Scatter', _0: a, _1: b, _2: c, _3: d};
	});
var _user$project$Main$validGraphs = function () {
	var baseScatter = A3(
		_user$project$Main$Scatter,
		'Concurrency',
		'Resp. Time (s)',
		function (_p31) {
			return _elm_lang$core$Basics$toFloat(
		...
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'Aggregated Time / Concurrency',
						_1: baseScatter(
							function (_p35) {
								return function (_) {
									return _.totalTime;
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'Mean Time Comparison',
								_1: A2(
									_user$project$Main$Timeline,
									'Resp. Time (s)',
									function (_p37) {
										return function (_) {
											return _.meanTime;
		...
		switch (_p40.ctor) {
			...
			case 'SearchButtonClicked':
				return {
					...
					_1: A2(
						_elm_lang$http$Http$send,
						_user$project$Main$LoadRunList,
						_user$project$Main$getRuns(model.searchField))
				};
			case 'RunTitleClicked':
				var _p41 = _p40._0;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
					...
					_1: A2(
						_elm_lang$http$Http$send,
						_user$project$Main$LoadRunList,
						_user$project$Main$getRuns(_p41))
				};
			case 'LoadRunTitles':
				if (_p40._0.ctor === 'Err') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								runTitles: _user$project$Main$extractTitles(_p40._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'LoadRunList':
				if (_p40._0.ctor === 'Err') {
					...
					var toRequest = function (_p42) {
						var _p43 = _p42;
						return A2(
							_elm_lang$http$Http$send,
							_user$project$Main$LoadRunStats,
							_user$project$Main$getSingleRun(_p43.id));
					};
					var requests = A2(_elm_lang$core$List$map, toRequest, _p40._0._0);
					return {
						ctor: '_Tuple2',
						_0: model,
			...
			case 'LoadRunStats':
				if (_p40._0.ctor === 'Err') {
					...
					var newRuns = {ctor: '::', _0: _p40._0._0, _1: model.runs};
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								runs: newRuns,
								filteredGroups: _user$project$Main$defaultFilteredGroups(newRuns)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			case 'ChangeGraphType':
				var appropriateConcurrency = function (runs) {
				...
				var graphType = _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (_p45) {
							var _p46 = _p45;
							return _elm_lang$core$Native_Utils.eq(_p46._0, _p40._0);
						},
						_user$project$Main$validGraphs));
				var _p47 = function () {
					var _p48 = graphType;
					if (_p48.ctor === 'Nothing') {
						return {ctor: '_Tuple2', _0: model.graph, _1: model.concurrencyComparison};
					} else {
						if (_p48._0._1.ctor === 'Timeline') {
							return {
								ctor: '_Tuple2',
								_0: _p48._0._0,
								_1: appropriateConcurrency(model.runs)
							};
						} else {
							return {ctor: '_Tuple2', _0: _p48._0._0, _1: _elm_lang$core$Maybe$Nothing};
						}
					}
				}();
				var newType = _p47._0;
				var newConcurrency = _p47._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{graph: newType, concurrencyComparison: newConcurrency}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ToggleFilterGroup':
				var _p49 = _p40._0;
				var filteredGroups = A2(_elm_lang$core$List$member, _p49, model.filteredGroups) ? A2(
					_elm_lang$core$List$filter,
					F2(
						function (x, y) {
							return !_elm_lang$core$Native_Utils.eq(x, y);
						})(_p49),
					model.filteredGroups) : {ctor: '::', _0: _p49, _1: model.filteredGroups};
				var newFilteredGroups = _elm_lang$core$List$isEmpty(filteredGroups) ? _user$project$Main$defaultFilteredGroups(model.runs) : filteredGroups;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							concurrencyComparison: _elm_lang$core$Maybe$Just(_p40._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Main$rightmostPanel = function (_p50) {
	var _p51 = _p50;
	var _p52 = _p51.runs;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Main$onChange(_user$project$Main$ChangeGraphType),
					_1: {ctor: '[]'}
				},
				A2(
					_elm_lang$core$List$map,
					_user$project$Main$renderGraphItem(_p51.graph),
					_user$project$Main$validGraphs)),
			_1: {
				ctor: '::',
				_0: A2(_user$project$Main$renderConcurrencySelector, _p51.concurrencyComparison, _p52),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Main$renderGroups, _p51.filteredGroups, _p52),
					_1: {
						ctor: '::',
						_0: A2(
						...
						_1: {
							ctor: '::',
							_0: _user$project$Main$renderPageList(_p52),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Main$graphDesc = function (title) {
	return _elm_lang$core$List$head(
		A2(
			_elm_lang$core$List$map,
			...
			A2(
				...
				function (_p53) {
					var _p54 = _p53;
					return _elm_lang$core$Native_Utils.eq(title, _p54._0);
				},
				_user$project$Main$validGraphs)));
};
var _user$project$Main$plotRuns = function (_p55) {
	var _p56 = _p55;
	var _p62 = _p56.runs;
	var _p61 = _p56.hovered;
	var _p60 = _p56.graph;
	var _p57 = _user$project$Main$graphDesc(_p60);
	if (_p57.ctor === 'Just') {
		if (_p57._0.ctor === 'Scatter') {
			return A5(
				_user$project$Main$basicSeries,
				_p61,
				_p57._0._0,
				_p57._0._1,
				{
					ctor: '::',
					_0: A3(_user$project$Main$scatterPlot, _p57._0._2, _p57._0._3, _p61),
					_1: {ctor: '[]'}
				},
				A2(
					_user$project$Main$filterGroups,
					_p56.filteredGroups,
					_user$project$Main$assignColors(_p62)));
		} else {
			var level = A2(_elm_lang$core$Maybe$withDefault, 0, _p56.concurrencyComparison);
			var runData = A2(
				_elm_lang$core$List$filter,
				function (r) {
					return _elm_lang$core$Native_Utils.eq(r.run.concurrency, level);
				},
				_p62);
			var dates = _elm_lang$core$Dict$fromList(
				A2(
					_elm_lang$core$List$indexedMap,
					F2(
						function (index, date) {
							return {
								ctor: '_Tuple2',
								_0: date,
								_1: _elm_lang$core$Basics$toFloat(index)
							};
						}),
					_elm_lang$core$List$sort(
						_elm_community$list_extra$List_Extra$unique(
							A2(
								...
								runData)))));
			var dateGetter = function (d) {
				return A2(
					_elm_lang$core$Maybe$withDefault,
					0,
					A2(
						_elm_lang$core$Dict$get,
						_elm_lang$core$Date$toTime(d.run.created),
						dates));
			};
			return A5(
				_user$project$Main$basicSeries,
				...
				{
					ctor: '::',
					_0: A3(_user$project$Main$linePlot, dateGetter, _p57._0._1, _p61),
					_1: {ctor: '[]'}
				},
				_user$project$Main$assignColors(runData));
		}
	} else {
...
var _user$project$Main$rightPanel = function (model) {
	...
	if (_p63.ctor === '[]') {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('view-plot view-plot__closed'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$plotRuns(model),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$rightmostPanel(model),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
		...
		{ctor: '[]'},
		{
			...
			_0: A3(
				...
				'link',
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href('/assets/main.css'),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Main$leftPanel, model.searchField, model.runTitles),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
